...
#%%
df = pd.read_csv("C:\\Users\\manci\\Desktop\\Materias Actuales\\Curso Analisis de Datos con Python\\Notas y ejercicios para la clase\\clase 3/Production_Crops_E_All_Data.csv",  encoding = "ISO-8859-1")
df
#%%
